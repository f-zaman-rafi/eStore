...
const Phone = () => {
  ...
  return (
    <div className="pb-10 lg:px-20 px-10 my-10 min-h-[80vh] max-w-[1440px] mx-auto font-inter overflow-x-hidden">
      ...
      <h1 className="text-2xl font-medium text-gray-800 dark:text-white px-4 py-10">
        Add Phone
      </h1>
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-y-5 gap-x-10 pt-10">
            ...
            <div className="form-control mb-4">
              ...
              <select
                id="mainCamera"
                {...register("mainCamera", {
                  required: "Main Camera is required",
                })}
                className="input input-bordered w-full"
              >
                <option value="" selected>
            ...
            <div className="form-control mb-4">
              ...
              <select
                id="headphoneType"
                {...register("headphoneType", {
                  required: "Headphone type is required",
                })}
                className="input input-bordered w-full"
              >
                <option value="" selected>
            ...
            <div className="form-control mb-4">
              ...
              <select
                id="gamingDeviceType"
                {...register("gamingDeviceType", {
                  required: "Gaming device type is required",
                })}
                className="input input-bordered w-full"
              >
                <option value="" selected>
            ...
            <div className="form-control">
              ...
              >
                ...
                <option value="IP68">
                  IP68 - Dust tight and water-resistant to a greater depth
                </option>
                <option value="IPX7">
                  IPX7 - Protected against water immersion
                </option>
                <option value="IPX8">
                  IPX8 - Protected against prolonged water immersion
                </option>
              </select>
              ...
              <div className="grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4">
                {[
                  ...
                  <div key={size}>
                    ...
                    />
                    <label htmlFor={`storage-${size}`} className="ml-2">
                      {size}
                    </label>
        ...
        <div className="text-center py-10 ">
          <input
            className="btn btn-outline btn-wide btn-circle"
            type="submit"
          />
        </div>
      </form>
