  ...
  const {
    ...
    queryFn: async () => {
      const [phones, smartWatches, cameras, headphones, computers, consoles] =
        await Promise.all([
          axiosCommon.get(`/phones?status=featured_product`),
          axiosCommon.get(`/smartWatches?status=featured_product`),
          axiosCommon.get(`/cameras?status=featured_product`),
          axiosCommon.get(`/headphones?status=featured_product`),
          axiosCommon.get(`/computers?status=featured_product`),
          axiosCommon.get(`/consoles?status=featured_product`),
        ]);
