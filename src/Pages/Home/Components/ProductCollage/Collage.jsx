...
import vision from "../../../../assets/images/visionPro.png"
        ...
        <div className='flex flex-col lg:flex-row lg:max-h-[600px] overflow-hidden max-w-[1440px] mx-auto font-inter'>
            <div className='flex-1 flex lg:flex-col flex-col-reverse'>
                ...
                <div className='relative md:justify-center lg:justify-start min-h-[328px] flex flex-col md:flex-row items-center lg:items-start py-10 lg:py-0 text-center md:text-start'>
                    <div className='flex-1 '>
                        <img className=' lg:absolute lg:h-[343px] lg:-left-16 h-[300px] mx-10 lg:m-0 ' src={playStation} alt="" />
                    </div>
                ...
                <div className='flex flex-col lg:flex-row'>
                    ...
                    <div className='flex-1 flex flex-col md:flex-row text-center md:text-start lg:text-start items-center lg:items-start relative bg-[#353535] py-10 lg:py-0 overflow-hidden'>
                        <div className='flex-1 lg:flex-auto '><img className='lg:absolute lg:right-[51%] mx-10 h-[200px] md:h-[300px] lg:h-full' src={vision} alt="" /></div>
            ...
            <div className='flex-1 bg-[#EDEDED] overflow-hidden py-5 lg:py-0'>
                <div className='lg:relative flex flex-col md:flex-row-reverse lg:flex-col items-center lg:items-start text-center md:text-start'>
                    <div className='flex-1'>
                        <img className='lg:absolute lg:-bottom-[20%] lg:left-2/3 lg:right-1/2 h-52 md:h-[280px] lg:h-full px-5 md:px-0' src={macbook} alt="" />
                    </div>
