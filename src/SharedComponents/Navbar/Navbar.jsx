          ...
          {user ? (
            ...
            <div className="dropdown dropdown-hover dropdown-end">
              <div tabIndex={0} className="flex items-center cursor-pointer">
                <img
                  className="h-7 mt-1 rounded-full"
                  src={user.photoURL}
                  alt="user"
                />
              </div>
              <ul
                tabIndex={0}
                className="dropdown-content menu menu-sm p-2 shadow bg-gray-200 bg-opacity-80 font-semibold text-stone-800 rounded-box w-auto min-w-max"
              >
                {userMenu}
              </ul>
            </div>
